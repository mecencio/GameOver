...
from profiles.views import my_profile_view, edit_information_view, address_view, add_address_view, delete_address_view, edit_address_view, my_purchases_view
